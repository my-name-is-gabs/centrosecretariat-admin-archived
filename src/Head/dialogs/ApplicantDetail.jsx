        ...
        >
          ...
          <Stack marginY="30px" spacing={2}>
            ...
            <TextField
              ...
              size="small"
              label="District"
              value={fetchApplicantProfile?.disctrict}
              InputProps={{
                readOnly: true,
              }}
            />
          ...
          <Stack marginY="30px" spacing={2}>
            ...
            <TextField
              ...
              size="small"
              label="Graduating"
              value={fetchApplicantProfile?.is_graduating}
              InputProps={{
                readOnly: true,
              }}
            />
          ...
          <Stack marginY="30px" spacing={2}>
            ...
            <TextField
              ...
              value={fetchApplicantProfile?.guardian_educational_attainment}
              InputProps={{
                readOnly: true,
              }}
            />
            ...
            <TextField
              ...
              size="small"
              label="Voter's ID issuance date"
              value={fetchApplicantProfile?.guardians_voters_issuance_date}
              InputProps={{
                readOnly: true,
              }}
            />
          ...
          <Stack marginY="30px" spacing={2}>
            ...
            <TextField
              ...
              value={fetchApplicantProfile?.is_applying_for_merit}
              InputProps={{
                readOnly: true,
              }}
            />
            ...
            <TextField
              ...
              size="small"
              label="Ladderized"
              value={fetchApplicantProfile?.is_ladderized}
              InputProps={{
                readOnly: true,
              }}
            />
